...
```sh
git clone git@github.com:KINGFIOX/chisel-verilator-example.git
cd chisel-verilator-example
```
...
#### Commit your changes
```sh
git commit -m 'Starting chisel-verilator-example'
...
```sh
mill chisel-verilator-example.test
```
